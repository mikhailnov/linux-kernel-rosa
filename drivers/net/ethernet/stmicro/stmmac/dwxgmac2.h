...
#define XGMAC_WDT_WTO_SHIFT		0
#define XGMAC_HASH_TABLE(x)		(0x00000010 + (x) * 4)
#define XGMAC_MAX_HASH_TABLE		8
#define XGMAC_VLAN_TAG			0x00000050
#define XGMAC_VLAN_EIVLRXS		BIT(31)
#define XGMAC_VLAN_EDVLP		BIT(26)
#define XGMAC_VLAN_VTHM			BIT(25)
#define XGMAC_VLAN_EVLRXS		BIT(24)
#define XGMAC_VLAN_EVLS_MASK		GENMASK(22, 21)
#define XGMAC_VLAN_EVLS_SHIFT		21
#define XGMAC_VLAN_TAG_STRIP_NONE	(0x0 << XGMAC_VLAN_EVLS_SHIFT)
#define XGMAC_VLAN_TAG_STRIP_PASS	(0x1 << XGMAC_VLAN_EVLS_SHIFT)
#define XGMAC_VLAN_TAG_STRIP_FAIL	(0x2 << XGMAC_VLAN_EVLS_SHIFT)
#define XGMAC_VLAN_TAG_STRIP_ALL	(0x3 << XGMAC_VLAN_EVLS_SHIFT)
...
#define XGMAC_DT			BIT(6)
#define XGMAC_RSF			BIT(5)
#define XGMAC_FEP			BIT(4)
...
#define XGMAC_OVFPKTCNT_SHIFT		0
